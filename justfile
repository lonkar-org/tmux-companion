...
act-ci:
    act --pull=false -W .github/workflows/ci.yml push
...
act-check:
    act --pull=false -W .github/workflows/ci.yml push -j check

# ci.yml, the rustdoc job.
act-docs:
    act --pull=false -W .github/workflows/ci.yml push -j docs

# ci.yml, the rustfmt job. Seconds, and the one worth running first.
act-format:
    act --pull=false -W .github/workflows/ci.yml push -j format

# What would run, without running it.
act-list:
    act --pull=false -W .github/workflows/ci.yml push --list
